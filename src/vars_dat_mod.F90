...
character(len= 16),dimension(radm):: cname=(/'Carbon Monoxide','NH3  ',&
'NO   ','SO2  ','ALDEHYDES  ','METHANE','CRESOL','Ethane','Glyoxal',&
'HC3  ','HC5  ','HC8  ','HCHO ','ISOPRENE','Acetone','Acrolein', 'MGLY ',&
'Methyl Vinil Ketone  ','Alkenes','alkenes   ','Terminal Alkynes',&
'Formic Acid','Acetic Acid ','TOLUENE  ','XYLENE  ','PM_10','PM_25 '&
,'Sulfates ','Nitrates ','PM25I','Organic ','Elemental Carbon  '&
,'SulfatesJ','NitratesJ','PM25J','Organic','Elemental Carbon',&
'biog isoprene','biog monoterpene','biog NO','biog NOx','biog other VOCs'/)
character (len=19) :: current_date,mecha

! Domain Variables
common /domain/ zlev, dix,djx,eix,ejx,grid_id,dx,dy,dxe,dye,Title
common /date/ id_grid,current_date,cday,mecha,cname,Times
common /wrf/ julyr,julday,mapproj,iswater,islake,isice,isurban,isoilwater,&
            ...
            gmt,num_land_cat,mminlu,map_proj_char
end module vars_dat
